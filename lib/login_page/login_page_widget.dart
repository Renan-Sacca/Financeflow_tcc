                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'p5hdf9zs' /* Create your account below. */,
                                      ),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'sbkel66h' /* Don't have an account? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText1,
                                        ),
